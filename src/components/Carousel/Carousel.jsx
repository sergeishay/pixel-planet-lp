...
const projects = [
  ...
  },
  {
    ...
    title: "VOICE OF THE PEOPLE",
      description:
       "עיצוב ופיתוח לאתר המייצג את תנועת “קול העם” השואפת לעצב את העתיד שלנו יחד בהובלת נשיא המדינה, מר יצחק הרצוג. יוזמת קול העם הינה חממה ששמה לה למטרה להצמיח ולבנות הנהגה יהודית בינלאומית.",
    service: "מיתוג, עיצוב ופיתוח אתר תדמית",
